...
public class TC04_Manager_Reject extends TestSuiteBase{
	...
	page.clickOnElement(ReadLocators.getPropertyvalue("loc.checkbox.btn", ProjectBaseConstantPaths.LOCATORS_FILE));
	page.clickOnElement(ReadLocators.getPropertyvalue("loc.reject.btn", ProjectBaseConstantPaths.LOCATORS_FILE));
